...
pdisk jest odpowiednikiem fdiska, umożliwiającym podgląd i modyfikację
tablic partycji zapisanych w formacie Apple Macintosh. Jest używany do
tworzenia partycji linuksowych na dysku, a także do tworzenia partycji
